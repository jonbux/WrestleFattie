    ...
    class WC_POS_Admin_Settings_General extends WC_Settings_Page
    {
        ...
        public function get_settings()
        {
            ...
            return apply_filters('woocommerce_point_of_sale_general_settings_fields', array(
                ...
                array(
                    'title' => __('My Account', 'wc_point_of_sale'),
                    'desc' => __('Enable front-end register access', 'wc_point_of_sale'),
                    'desc_tip' => __('Allows users to access the registers from thier associated My Account page.', 'wc_point_of_sale'),
                    'id' => 'wc_pos_my_account',
                    'default' => 'no',
                    'type' => 'checkbox',
                    'checkboxgroup' => 'start',
                ),
                ...
                array(
                    'title' => __('Report Title', 'wc_point_of_sale'),
                    'desc_tip' => __('Rename the title of your report to your.', 'wc_point_of_sale'),
                    'id' => 'wc_pos_report_title',
                    'default' => __('End of Day Report', 'wc_point_of_sale'),
                    'placeholder' => __('End of Day Report', 'wc_point_of_sale'),
                    'type' => 'text',
                ),
                ...
                array(
                    'title' => __('Report Order Count Status', 'wc_point_of_sale'),
                    'desc_tip' => __('Select which order statuses to include in the end of day report.', 'wc_point_of_sale'),
                    'id' => 'wc_pos_report_order_status',
                    'class' => 'wc-enhanced-select',
                    'type' => 'multiselect',
                ...
                array(
                    'name' => __('Save Prompt', 'woocommerce'),
                    'id' => 'wc_pos_order_prompt',
                    'std' => '',
                    'type' => 'checkbox',
                    'desc' => __('Display order save prompt', 'wc_point_of_sale'),
                    'desc_tip' => __('Enables the display of a confirmation prompt when saving an order.', 'wc_point_of_sale'),
                    'default' => 'no',
                    'autoload' => true
                ),
                ...
                array(
                    ...
                    'desc_tip' => __('Loads orders placed through the web store.', 'wc_point_of_sale'),
                    'default' => 'no',
                    'autoload' => true
                ),
                array(
