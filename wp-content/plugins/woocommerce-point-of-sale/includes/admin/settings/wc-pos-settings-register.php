        ...
        public function get_settings()
        {
            ...
            if ($current_section == 'scanning') {
                ...
                return apply_filters('woocommerce_point_of_sale_general_settings_fields', array(
                    ...
                    array(
                        'title' => __('Customer Indexing', 'wc_point_of_sale'),
                        'desc' => __('Disable indexing of customers', 'wc_point_of_sale'),
                        'desc_tip' => __('Disables the indexing and storage of customers in browser cache when register is loaded.', 'wc_point_of_sale'),
                        'id' => 'wc_pos_disable_customers_cache',
                        'default' => 'no',
                        'type' => 'checkbox',
                        'checkboxgroup' => 'start',
                    ),
                    ...
                    array(
                        ...
                        'desc_tip' => __('This gives you the ability to scan in orders, products to return and refund.', 'wc_point_of_sale'),
                        'id' => 'wc_pos_refund',
                        'default' => 'no',
                        'type' => 'checkbox',
                        'checkboxgroup' => 'start',
