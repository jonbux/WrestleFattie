	...
	public function get_settings() {
		...
		return apply_filters( 'woocommerce_point_of_sale_general_settings_fields', array(
			...
			array(
				...
				'desc_tip' => __( 'Allows decimal values to be used as stock quantity in register and through product editing.', 'wc_point_of_sale' ),
				'default'	=> 'no',
				'autoload'  => true					
			),
            ...
            array(
                'title'    => __( 'Tile Size', 'wc_point_of_sale' ),
                'desc_tip'     => __( 'This controls the size of the tiles.', 'wc_point_of_sale' ),
                'id'       => 'wc_pos_tile_size',
                'class'    => 'wc-enhanced-select',
                'css'      => 'min-width:300px;',
                'default'  => 'square',
                'type'     => 'select',
                'options'  => array(
                    'square' => __("Square Tiles", "wc_point_of_sale"),
                    'rectangle' => __("Rectangle Tiles", "wc_point_of_sale")
                ),
            ),
