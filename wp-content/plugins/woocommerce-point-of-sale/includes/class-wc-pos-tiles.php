        ...
        public function output()
        {
            ...
            if ('add' === $action) {
                ...
                if ($products_or_cat == 'category') {
                    ...
                    if(isset($_POST['category_type']) && $_POST['category_type'] == "auto"){
                        $data['background_color'] = '';
                        $data['text_color'] = '';
                        $data['default_selection'] = 0;
                        $data['tile_style'] = 'auto';
                        ...
                        <form action="" method="post" class="addGirdLayout" id="serach_tile_product" autocomplete="off">
                            <div class="col-wrap">
                                <div class="form-wrap">
                                    ...
                                    <div id="category_opt_wrap">
                                        <div class="form-field">
                                            ...
                                            <select id="category_id" class="category_chosen" style="width: 294px;"
                                                    name="category_id">
                                                <option value=""><?php _e('Select category', 'wc_point_of_sale'); ?></option>
                                                <?php
                                                if (!empty($terms)) {
                                    ...
                                    <div id="category_type_wrap">
                                        <div class="form-field">
                                            <label for="category_type"><?php _e('Category Type', 'wc_point_of_sale'); ?></label>
                                            <select id="category_type" class="category_type" style="width: 294px;" name="category_type">
                                                <option value=""><?php _e('Select tiles type', 'wc_point_of_sale'); ?></option>
                                                <option value="manual"><?php echo __('Manual', 'wc_point_of_sale'); ?></option>
                                                <option value="auto"><?php echo __('Auto', 'wc_point_of_sale'); ?></option>
                                            </select>
                                            <p class="description"><?php _e('Select how tiles to be populated according to the category.', 'wc_point_of_sale'); ?></p>
                                        </div>
                                    </div>
