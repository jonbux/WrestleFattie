...
class WC_Pos_Stocks {
	...
	public function display_single_stocks_page()
	{
		...
		<div class="wrap">
			...
			<p class="description"><?php _e( 'Manage your stock instantly using the barcode scanner. Simply scan the SKU and the product will load below with the option to enter updated stock value.', 'wc_point_of_sale' ); ?></p>
