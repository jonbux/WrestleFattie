...
class WC_API_POS_Orders extends WC_API_Orders
{
    ...
    public function edit_order($id, $data)
    {
        ...
        try {
            ...
            if(get_option('wc_pos_enable_cloud_print', 'disable') == "enable" && isset($data['print_receipt']) && $data['print_receipt'] == "true"){
...
//            echo "</pre>"; wp_die();
    ...
    public function calculate_order_totals($order, $data, $and_taxes = true)
    {
        ...
        $order->set_discount_total($cart_subtotal - $cart_total, 'cart_discount');
