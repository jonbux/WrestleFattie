<style>
	...
	#pos_customer_info, #pos_receipt_title, #pos_receipt_logo, #pos_receipt_contact, #pos_receipt_tax, #pos_receipt_header, 		#pos_receipt_items, .display-socials, #pos_receipt_address, #pos_receipt_info, #pos_receipt_tax_breakdown {
...
<div class="pos_receipt">
        ...
        <table class="order-info">
            ...
            <tr id="print_order_time">
                ...
                <td><span id="print-order_date_format"><?php
                        $order_date[] = date_i18n("h:i");
                        $order_date[] = date_i18n($receipt_options['order_date_format'], strtotime($order_date[0]));
                        echo $order_date[1]; ?> <?php _e('at', 'wc_point_of_sale'); ?> <?php echo $order_date[0]; ?></span></td>
            </tr>
            ...
            <tr id="print_order_notes">
                ...
                <td><?php _e('Please deliver this tomorrow at 12pm.', 'wc_point_of_sale'); ?></td>
            </tr>
            <?php if (isset($receipt_options['print_diner_option_label'])): ?>
                <tr id="print_diner_option_notes">
                    <th><span id="print-order_notes_label"><?php echo $receipt_options['print_diner_option_label']; ?></span></th>
                    <td><?php _e('Delivery', 'wc_point_of_sale'); ?></td>
                </tr>
            <?php endif; ?>
            </tbody>
        </table>
    ...
    <div id="pos_receipt_items">
        <table class="receipt_items">
            ...
            <tr>
                ...
                <td>
                    <div class="cost"
                        ...
                        <span style="<?php echo ($receipt_options['show_discount'] == 'yes') ? 'text-decoration:line-through	' : '' ?>">£59.00</span>
                    </div>
                    <div class="discount_cost"
                         style="display: <?php echo ($receipt_options['show_discount'] == 'yes') ? '' : 'none' ?>">
                        £55.00
                    </div>
                </td>
                <td style="display: <?php echo ($receipt_options['show_discount'] == 'yes') ? 'none' : '' ?>" class="discount_disable">£118.00</td>
                <td style="display: <?php echo ($receipt_options['show_discount'] == 'yes') ? '' : 'none' ?>" class="discount_enable">£110.00</td>
            </tr>
            </tbody>
            <tfoot>
            <tr>
            ...
            <tr>
                ...
                <td style="display: <?php echo ($receipt_options['show_discount'] == 'yes') ? 'none' : '' ?>" class="discount_disable">£23.60</td>
                <td style="display: <?php echo ($receipt_options['show_discount'] == 'yes') ? '' : 'none' ?>" class="discount_enable">£22.00</td>
            ...
            <tr>
                ...
                <td style="display: <?php echo ($receipt_options['show_discount'] == 'yes') ? 'none' : '' ?>" class="discount_disable">£141.60</td>
                <td style="display: <?php echo ($receipt_options['show_discount'] == 'yes') ? '' : 'none' ?>" class="discount_enable">£132.00</td>
            </tr>
            <tr>
                <th class="column-product-image"></th>
                <th scope="row" colspan="3">
    ...
    <div id="pos_receipt_barcode">
        <center>
            <p>
                <img src="<?php echo WC_POS()->plugin_url() . '/includes/lib/barcode/image.php?filetype=PNG&dpi=72&scale=2&rotation=0&font_family=0&font_size=12&thickness=30&start=NULL&code=BCGcode128&text=WC-123'; ?>"
                     alt=""></p>
        </center>
    </div>
