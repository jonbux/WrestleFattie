...
class WC_POS_Install
{
    ...
    public static $db_updates = array(
        ...
        '4.2.8' => 'wc_pos-update-4.2.8.php',
        '4.2.8.5' => 'wc_pos-update-4.2.8.5.php',
        '4.2.9' => 'wc_pos-update-4.2.9.php',
        '4.3.1' => 'wc_pos-update-4.3.1.php',
        '4.3.6' => 'wc_pos-update-4.3.6.php',
        '4.4' => 'wc_pos-update-4.4.php',
        '4.4.5' => 'updates/wc_pos-update-4.4.5.php',
        '4.4.6' => 'updates/wc_pos-update-4.4.6.php',
    );
    ...
    private static function create_tables()
    {
        ...
        if ($installed_ver != WC_POS_VERSION) {
            ...
            order_dining_option text DEFAULT '' NOT NULL,
            ...
            print_by_pos_printer varchar(255) DEFAULT '' NOT NULL,
            ...
            AND column_name = 'show_discount'"))
                ...
                $wpdb->query("ALTER TABLE {$wpdb->prefix}wc_poin_of_sale_receipts ADD `show_discount` VARCHAR (11) NOT NULL DEFAULT 'no' ");
            }
            ...
            AND column_name = 'print_by_pos_printer'"))
                ...
                $wpdb->query("ALTER TABLE {$wpdb->prefix}wc_poin_of_sale_receipts ADD `print_by_pos_printer` VARCHAR (255) NOT NULL DEFAULT 'no' ");
            }
