...
if (!class_exists('WC_Pos_Receipts')) :
    ...
    class WC_Pos_Receipts
    {
                                ...
                                <div class="meta-box-sortables">
                                    <div class="postbox ">
                                        ...
                                        <div class="inside">
                                            <p class="hide-if-no-js">
                                                <?php $receipt_logo_style = (!$receipt_options['logo']) ? 'style="display: none;"' : ''; ?></p>
                                    ...
                                    <div class="postbox ">
                                        ...
                                        <div class="inside">
	                                        ...
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="gift_receipt_title"><?php _e('Receipt Gift Title', 'wc_point_of_sale'); ?></label>
		                                         <input type="text" id="gift_receipt_title" name="gift_receipt_title" value="<?php echo $receipt_options['gift_receipt_title']; ?>">
	                                        </p>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_copies_count"><?php _e('Number of Copies', 'wc_point_of_sale'); ?></label>
                                                <select id="receipt_print_copies_count"
                                                        name="print_copies_count">
                                                    <option value="1" <?php echo ($receipt_options['print_copies_count'] == 1) ? 'selected' : '' ?>>1</option>
                                                    <option value="2" <?php echo ($receipt_options['print_copies_count'] == 2) ? 'selected' : '' ?>>2</option>
                                                    <option value="3" <?php echo ($receipt_options['print_copies_count'] == 3) ? 'selected' : '' ?>>3</option>
                                                    <option value="4" <?php echo ($receipt_options['print_copies_count'] == 4) ? 'selected' : '' ?>>4</option>
                                                    <option value="5" <?php echo ($receipt_options['print_copies_count'] == 5) ? 'selected' : '' ?>>5</option>
                                                </select>
	                                        </p>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_width"><?php _e('Print Width', 'wc_point_of_sale'); ?></label>
                                                <input type="number" name="receipt_width"
                                                       class="form-control bfh-number" id="receipt_width"
                                                       min="0" max="120" step="5" default="0"
                                                       value="<?php echo $receipt_options['receipt_width']; ?>" style="width: 50px;"/><span
                                                        style="margin-left: 10px; line-height: 2;">mm</span><br>
                                                <span style="margin-top: 1em; background: #f5f5f5; border: 1px solid #ddd; border-radius: 5px; padding: .5em 1em; margin-left: 49%; display: inline-block;"><?php _e('0mm = Dynamic Width', 'wc_point_of_sale'); ?></span>
	                                        </p>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_tax_summary"><?php _e('Tax Summary', 'wc_point_of_sale'); ?></label>
                                                <input type="checkbox" value="yes"
                                                       id="receipt_print_tax_summary"
                                                       name="tax_summary" <?php echo ($receipt_options['tax_summary'] == 'yes') ? 'checked="checked"' : ''; ?>>
	                                        </p>
                                            <p class="form-field">
                                                <label class="receipt_labels" for="receipt_print_by_pos_printer"><?php _e('Receipt type', 'wc_point_of_sale'); ?></label>
                                                <select name="receipt_print_by_pos_printer" id="receipt_print_by_pos_printer">
                                                    <option value="html" <?php selected($receipt_options['print_by_pos_printer'], "html", true) ?> ><?php _e('HTML', 'wc_point_of_sale') ?></option>
                                                    <option value="normal" <?php selected($receipt_options['print_by_pos_printer'], "normal", true) ?> ><?php _e('Normal', 'wc_point_of_sale') ?></option>
                                                </select>
                                            </p>
                                        </div>
                                    ...
                                    <div class="postbox ">
                                        ...
                                        <div class="inside">
	                                        ...
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="contact_position"><?php _e('Outlet Details Position', 'wc_point_of_sale'); ?></label>
                                    ...
                                    <div class="postbox ">
                                        ...
                                        <div class="inside">
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="show_site_name"><?php _e('Shop Name', 'wc_point_of_sale'); ?></label>
                                                <input type="checkbox" id="show_site_name"
                                                       value="yes"
                                                       name="show_site_name" <?php echo ($receipt_options['show_site_name'] == 'yes') ? 'checked="checked"' : ''; ?>>
	                                        </p>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="show_outlet"><?php _e('Outlet Name', 'wc_point_of_sale'); ?></label>
		                                        <input type="checkbox" id="show_outlet"
                                                               value="yes"
                                                               name="show_outlet" <?php echo ($receipt_options['show_outlet'] == 'yes') ? 'checked="checked"' : ''; ?>>
	                                        </p>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_outlet_address"><?php _e('Outlet Address', 'wc_point_of_sale'); ?></label>
	                                        ...
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_outlet_contact_details"><?php _e('Outlet Contact Details', 'wc_point_of_sale'); ?></label>
	                                        ...
	                                        <p class="form-field show_receipt_print_outlet_contact_details">
	                                        ...
	                                        <p class="form-field show_receipt_print_outlet_contact_details">
		                                        <label class="receipt_labels" for="socials_display_option"><?php _e('Social Details', 'wc_point_of_sale'); ?></label>
	                                        ...
	                                        <p class="form-field social">
		                                        <label class="receipt_labels" for="show_twitter"><?php _e('Twitter Label', 'wc_point_of_sale'); ?></label>
                                                <input type="checkbox" id="show_twitter" value="yes"
                                                       name="show_twitter" <?php echo ($receipt_options['show_twitter'] == 'yes') ? 'checked="checked"' : ''; ?>>
	                                        </p>
	                                        <p class="form-field social">
		                                        <label class="receipt_labels" for="show_facebook"><?php _e('Facebook Label', 'wc_point_of_sale'); ?></label>
	                                        ...
	                                        <p class="form-field social">
		                                        <label class="receipt_labels" for="show_instagram"><?php _e('Instagram Label', 'wc_point_of_sale'); ?></label>
	                                        ...
	                                        <p class="form-field social">
		                                        <label class="receipt_labels" for="show_snapchat"><?php _e('Snapchat Label', 'wc_point_of_sale'); ?></label>
	                                        ...
	                                        <hr>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_tax_number"><?php _e('Tax Number', 'wc_point_of_sale'); ?></label>
                                                ...
                                                <input class="show_receipt_print_tax_number receipt_label_text" type="text" id="receipt_tax_number_label"
                                    ...
                                    <div class="postbox ">
                                        ...
                                        <div class="inside">
	                                        ...
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_order_time"><?php _e('Order Date', 'wc_point_of_sale'); ?></label>
                                                ...
                                                <input class="show_receipt_print_order_time receipt_label_text" type="text" id="receipt_order_date_label"
                                                       name="receipt_order_date_label"
                                                       value="<?php echo $receipt_options['order_date_label']; ?>">
	                                        </p>
	                                        <p class="form-field show_receipt_print_order_time">
		                                        <label class="receipt_labels" for="receipt_order_date_format"><?php _e('Order Date Format', 'wc_point_of_sale'); ?></label>
                                                <?php
                                            ...
                                            <p class="form-field">
                                                <label class="receipt_labels" for="receipt_print_dining_option"><?php _e('Dining Option', 'wc_point_of_sale'); ?></label>
                                                <input type="checkbox" id="receipt_print_dining_option" value="yes"
                                                       name="receipt_print_dining_option" <?php echo (isset($receipt_options['print_dining_option']) && $receipt_options['print_dining_option'] == 'yes') ? 'checked="checked"' : ''; ?>>
                                            </p>
                                            <p class="form-field">
                                                <label class="receipt_labels" for="receipt_print_tab"><?php _e('Tab', 'wc_point_of_sale'); ?></label>
                                                <input type="checkbox" id="receipt_print_tab" value="yes"
                                                       name="receipt_print_tab" <?php echo (isset($receipt_options['print_tab']) && $receipt_options['print_tab'] == 'yes') ? 'checked="checked"' : ''; ?>>
                                            </p>
	                                        <hr>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_customer_name"><?php _e('Customer Name', 'wc_point_of_sale'); ?></label>
                                                ...
                                                <input class="show_receipt_print_customer_name receipt_label_text" type="text" id="receipt_customer_name_label"
                                                       name="receipt_customer_name_label"
                                                       value="<?php echo $receipt_options['customer_name_label']; ?>">
	                                        </p>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_customer_email"><?php _e('Customer Email', 'wc_point_of_sale'); ?></label>
                                                ...
                                                <input class="show_receipt_print_customer_email receipt_label_text" type="text" id="receipt_customer_email_label"
                                                       name="receipt_customer_email_label"
                                                       value="<?php echo $receipt_options['customer_email_label']; ?>">
	                                        </p>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_customer_phone"><?php _e('Customer Telephone', 'wc_point_of_sale'); ?></label>
                                                ...
                                                <input class="show_receipt_print_customer_phone receipt_label_text" type="text" id="receipt_customer_phone_label"
                                                       name="receipt_customer_phone_label"
                                                       value="<?php echo $receipt_options['customer_phone_label']; ?>">
	                                        </p>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_customer_ship_address"><?php _e('Shipping Address', 'wc_point_of_sale'); ?></label>
                                                ...
                                                <input class="show_receipt_print_customer_ship_address receipt_label_text" type="text" id="receipt_customer_ship_address_label"
                                                       name="receipt_customer_ship_address_label"
                                                       value="<?php echo $receipt_options['customer_ship_address_label']; ?>">
	                                        </p>
	                                        <hr>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_server"><?php _e('Cashier Name', 'wc_point_of_sale'); ?></label>
	                                        ...
	                                        <p class="form-field show_receipt_print_register_name_served">
		                                        <label class="receipt_labels" for="show_register"><?php _e('Register Name', 'wc_point_of_sale'); ?></label>
	                                        ...
	                                        <p class="form-field show_receipt_print_server">
	                                        ...
	                                        <p class="form-field show_receipt_print_server">
		                                        <label class="receipt_labels" for="receipt_served_by_type"><?php _e('Served By Type', 'wc_point_of_sale'); ?></label>
                                    ...
                                    <div class="postbox ">
                                        ...
                                        <div class="inside">
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_show_image_product"><?php _e('Product Image', 'wc_point_of_sale'); ?></label>
	                                        ...
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="show_sku"><?php _e('Product SKU', 'wc_point_of_sale'); ?></label>
                                                <input type="checkbox" id="show_sku" value="yes"
                                                       name="show_sku" <?php echo ($receipt_options['show_sku'] == 'yes') ? 'checked="checked"' : ''; ?>>
	                                        </p>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="show_cost"><?php _e('Product Cost', 'wc_point_of_sale'); ?></label>
                                                <input type="checkbox" id="show_cost" value="yes"
                                                       name="show_cost" <?php echo ($receipt_options['show_cost'] == 'yes') ? 'checked="checked"' : ''; ?>>
	                                        </p>
                                            <p class="form-field">
		                                        <label class="receipt_labels" for="show_discount"><?php _e('Product Discount', 'wc_point_of_sale'); ?></label>
                                                <input type="checkbox" id="show_discount" value="yes"
                                                       name="show_discount" <?php echo ($receipt_options['show_discount'] == 'yes') ? 'checked="checked"' : ''; ?>>
	                                        </p>
	                                        <hr>
	                                        <p class="form-field">
	                                        ...
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_number_items"><?php _e('Number of Items', 'wc_point_of_sale'); ?></label>
                                                <input type="checkbox" id="receipt_print_number_items"
                                                 ...
                                                 <input class="show_receipt_print_number_items receipt_label_text" type="text" id="receipt_items_label"
                                                       name="receipt_items_label"
                                                       value="<?php echo $receipt_options['items_label']; ?>">
	                                        </p>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_order_notes"><?php _e('Order Notes', 'wc_point_of_sale'); ?></label>
                                                ...
                                                <input class="show_receipt_print_order_notes receipt_label_text" type="text" id="receipt_order_notes_label"
                                                       name="receipt_order_notes_label"
                                                       value="<?php echo $receipt_options['order_notes_label']; ?>">
	                                        </p>
	                                        <p class="form-field">
		                                        <label class="receipt_labels" for="receipt_print_barcode"><?php _e('Order Barcode', 'wc_point_of_sale'); ?></label>
        ...
        function display_messages()
        {
            ...
            $back_to_receipts = sprintf('<a href="%1$s">%2$s</a>',
                add_query_arg( array('page' => WC_POS()->id_receipts), admin_url('admin.php') ),
                __('&larr; Back to Receipts', 'wc-point-of-sale')
            );
            $messages = array(
                0 => '', // Unused. Messages start at index 1.
                1 => '<div id="message" class="notice notice-success"><p><strong>' . __('Receipt template created.') . '</strong></p><p>'.$back_to_receipts.'</p></div>',
                2 => '<div id="message" class="notice notice-success"><p><strong>' . __('Receipt template updated.') . '</strong></p><p>'.$back_to_receipts.'</p></div>',
                3 => '<div id="message" class="notice notice-success"><p><strong>' . __('Receipt template deleted.') . '</strong></p><p>'.$back_to_receipts.'</p></div>',
            );
            return $messages[$i];
        }
        ...
        public function save_receipt()
        {
            ...
            $data = array(
                ...
                'print_by_pos_printer' => isset($_POST['receipt_print_by_pos_printer']) ? $_POST['receipt_print_by_pos_printer'] : 'html',
                ...
                'show_discount' => isset($_POST['show_discount']) ? $_POST['show_discount'] : '',
                ...
                'print_dining_option' => isset($_POST['receipt_print_dining_option']) ? $_POST['receipt_print_dining_option'] : 'no',
                'print_tab' => isset($_POST['receipt_print_tab']) ? $_POST['receipt_print_tab'] : 'no',
            );
            $table_name = $wpdb->prefix . "wc_poin_of_sale_receipts";
        ...
        {
            $elems = 'body.pos_receipt, table.order-info, table.customer-info, table.receipt_items, div#pos_receipt_title, div#pos_receipt_address, div#pos_receipt_contact, div#pos_receipt_header, div#pos_receipt_header p, div#pos_receipt_footer, div#pos_receipt_footer p, div#pos_receipt_tax, div#pos_receipt_info, div#pos_receipt_items, div#receipt_print_tax_summary, div#pos_receipt_tax_breakdown, table.tax_breakdown';
            $templates = array(
                'text_size' => array(
                    'normal' => $elems . '{font-size: 12px;}',
                    'small' => $elems . '{font-size: 10px;}',
                    'large' => $elems . '{font-size: 14px;}',
                ),
                'title_position' => array(
                    'left' => 'div#pos_receipt_title {text-align: left;}',
                    'center' => 'div#pos_receipt_title {text-align: center;}',
                    'right' => 'div#pos_receipt_title {text-align: right;}',
                ),
                'logo_size' => array(
                    'normal' => 'div#print_receipt_logo {height: 50px;}',
                    'small' => 'div#print_receipt_logo {height: 25px;}',
                    'large' => 'div#print_receipt_logo {height: 100px;}',
                ),
                'logo_position' => array(
                    'left' => 'div#pos_receipt_logo {text-align: left;}',
                    'center' => 'div#pos_receipt_logo {text-align: center;}',
                    'right' => 'div#pos_receipt_logo {text-align: right;}',
                ),
                'contact_position' => array(
                    'left' => 'div#pos_receipt_address, div#pos_receipt_contact, div.display-socials {text-align: left;}',
                    'center' => 'div#pos_receipt_address, div#pos_receipt_contact, div.display-socials {text-align: center;}',
                    'right' => 'div#pos_receipt_address, div#pos_receipt_contact, div.display-socials {text-align: right;}',
                ),
                'tax_number_position' => array(
                    'left' => 'div#pos_receipt_tax {text-align: left;}',
                    'center' => 'div#pos_receipt_tax {text-align: center;}',
                    'right' => 'div#pos_receipt_tax {text-align: right;}',
                ),
            );
