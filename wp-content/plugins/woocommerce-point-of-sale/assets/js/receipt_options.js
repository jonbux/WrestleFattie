jQuery(document).ready(function ($) {
    ...
    $('#show_discount').change(function () {
        if ($(this).is(':checked')) {
            $('table.receipt_items .discount_cost').show();
            $('table.receipt_items .cost span').css('text-decoration', 'line-through');
            $('.discount_disable').hide();
            $('.discount_enable').show();
        } else {
            $('table.receipt_items .discount_cost').hide();
            $('table.receipt_items .cost span').css('text-decoration', 'none');
            $('.discount_disable').show();
            $('.discount_enable').hide();
        }
    }).trigger('change');
